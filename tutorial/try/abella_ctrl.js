    ...
    app.controller('AbellaController', ['$scope', function($scope){
        ...
        $scope.devs = [
            ...
            { name: "3.1 - Typing and Sybject Reduction",
              ...
              thm: "examples/stlc_subjred.thm" },
            { name: "3.2 - Type Uniqueness",
              sig: "examples/stlc.sig",
              mod: "examples/stlc.mod",
              thm: "examples/stlc_uniq.thm" },
            { name: "3.3 - Partitioning",
              sig: "examples/partition.sig",
              mod: "examples/partition.mod",
              thm: "examples/partition.thm" },
            { name: "--- 4. Co-Induction ---",
              disable: true },
            { name: "4.1 - Automata",
              thm: "examples/automata.thm" },
            { name: "4.2 - Divergence",
              sig: "examples/divergence.sig",
              mod: "examples/divergence.mod",
              thm: "examples/divergence.thm" },
        ];
